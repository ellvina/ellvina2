package com.example.ideapad300.ellvina;
...
public class OrderActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mListMenu.add("Bralette");
        mListMenu.add("Flower Jelly Lipstick");
        mListMenu.add("Ballerina Flatshoes");
        mListMenu.add("Stitch Onesie");
        mListMenu.add("Popsockets"); //memasukan info ke spinner
    ...
    public void onClickOrder(View view) { //hanya memilih salah satu radiobox dan mendapatkan text untuk item
        ...
        String to = "ellvinareksi@gmail.com";
